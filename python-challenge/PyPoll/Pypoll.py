...
election_data_file = Path("Desktop", "python-challenge","PyPoll", "Resources", "election_data.csv")
...
output_file = Path("Desktop", "Homework 3 Python", "Election_Results_Summary.txt")
...
# Write methods to print to Elections_Results_Summary 
    ...
    file.write("----------------------------")
    file.write("\n")
    file.write("Khan: {khan_percent:.3f}% ({khan_votes})")
    file.write("\n")
    file.write("Correy: {correy_percent:.3f}% ({correy_votes})")
    file.write("\n")
    file.write("Li: {li_percent:.3f}% ({li_votes})")
    file.write("\n")
    file.write("O'Tooley: {otooley_percent:.3f}% ({otooley_votes})")
    file.write("\n")
    file.write("----------------------------")
    file.write("\n")
